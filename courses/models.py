...
class Klasa(models.Model):
    ...
    images = models.ImageField(upload_to='cat_images', default='cat_images/default.jpg')

    def __str__(self):
        return '{}'.format(self.titles)
...
class Lendet(models.Model):
    ...
    creator = models.DateTimeField(auto_now=True)
    images_len = models.ImageField(upload_to='kurs_images', default='default.jpg')
    ...
    @property
    def lessons(self):
        return self.lesson_set.all().order_by('positions')
